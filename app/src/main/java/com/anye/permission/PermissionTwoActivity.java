...
public class PermissionTwoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (R.id.permission_one == id) {
            ...
            if (PermissionManager.getInstance(getApplicationContext()).getGrantedInfo(Manifest.permission.RECORD_AUDIO)) {
                ...
                Toast.makeText(PermissionTwoActivity.this, "你还没有获取录音权限", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
